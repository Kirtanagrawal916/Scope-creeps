...
doc.setFontSize(10);
doc.text(
  "1.1 User Authentication System: Signup, Login, Password Reset, and JWT sessions.",
  16,
  72,
);
doc.text(
  "1.2 Product Catalog & Search: Filter products by category, sort by price, search bar.",
  16,
  78,
);
doc.text(
  "1.3 Single-Currency Shopping Cart: INR cart calculations, promo codes, order summary.",
  16,
  84,
);
doc.text(
  "1.4 Payment Gateway Integration: Razorpay integration for INR credit/debit cards.",
  16,
  90,
);
doc.text(
  "1.5 Admin Inventory Panel: Basic view to update stock quantities and view orders.",
  16,
  96,
);
...
doc.setFontSize(10);
doc.text(
  "2.1 Multi-Currency Conversion: Automated currency rates (USD/EUR) is OUT OF SCOPE.",
  16,
  122,
);
doc.text(
  "2.2 Cryptocurrency Payments: Bitcoin/USDT/Crypto payment gateways is OUT OF SCOPE.",
  16,
  128,
);
doc.text(
  "2.3 Custom Mobile Apps: Native iOS (Swift) and Android (Kotlin) apps are OUT OF SCOPE.",
  16,
  134,
);
doc.text(
  "2.4 Automated CSV/PDF Reports: Real-time custom financial exports are OUT OF SCOPE.",
  16,
  140,
);
...
doc.setFontSize(10);
doc.text(
  "Any feature request not explicitly listed in Section 1 shall be classified as a Change Order.",
  16,
  166,
);
doc.text(
  "Change orders will be billed at the contractor's hourly rate of INR 150/hr upon client written",
  16,
  172,
);
...
doc.setFont("helvetica", "normal");
doc.text(
  "Sarah Jenkins, CEO (Atlas Retail Group)           Bhavya Juneja, Lead Engineer (ScopeGuard)",
  14,
  202,
);
